...
const TEAM_DATA = {
  MEX: { name:'Mexico',            flag:'🇲🇽', fifaRank:16, heat:89, pitch:61, altitude:100, travel:80, crowd:78, schedule:49, insight:'Home comforts dominate — unmatched altitude and heat resilience.' },
  RSA: { name:'South Africa',      flag:'🇿🇦', fifaRank:62, heat:84, pitch:22, altitude:71,  travel:50, crowd:38, schedule:29, insight:'Strong heat tolerance from PSL conditions.' },
  KOR: { name:'South Korea',       flag:'🇰🇷', fifaRank:23, heat:47, pitch:74, altitude:28,  travel:18, crowd:69, schedule:94, insight:'K-League discipline shines in schedule management.' },
  CZE: { name:'Czechia',           flag:'🇨🇿', fifaRank:37, heat:23, pitch:79, altitude:22,  travel:55, crowd:26, schedule:55, insight:'European pitch comfort but struggles with NA heat.' },
  CAN: { name:'Canada',            flag:'🇨🇦', fifaRank:47, heat:16, pitch:53, altitude:33,  travel:85, crowd:16, schedule:43, insight:'Host advantage on travel.' },
  BIH: { name:'Bosnia-Herzegovina',flag:'🇧🇦', fifaRank:64, heat:41, pitch:48, altitude:45,  travel:60, crowd:44, schedule:32, insight:'Heaviest group-stage travel burden in the field.' },
  QAT: { name:'Qatar',             flag:'🇶🇦', fifaRank:58, heat:100,pitch:69, altitude:22,  travel:70, crowd:1,  schedule:21, insight:'Highest heat score. Crowd atmosphere unfamiliar away.' },
  SUI: { name:'Switzerland',       flag:'🇨🇭', fifaRank:20, heat:34, pitch:84, altitude:79,  travel:75, crowd:32, schedule:72, insight:'Uniquely altitude-resistant. Deep squad.' },
  ...
  MAR: { name:'Morocco',           flag:'🇲🇦', fifaRank:14, heat:82, pitch:43, altitude:64,  travel:60, crowd:63, schedule:43, insight:'2022 semi-finalists. North African heat asset.' },
  HAI: { name:'Haiti',             flag:'🇭🇹', fifaRank:83, heat:87, pitch:1,  altitude:28,  travel:36, crowd:26, schedule:1,  insight:'Caribbean heat resilience. Pitch concerns.' },
  SCO: { name:'Scotland',          flag:'🏴󠁧󠁢󠁳󠁣󠁴󠁿', fifaRank:39, heat:1,  pitch:79, altitude:1,   travel:60, crowd:57, schedule:49, insight:'Heat is the biggest threat.' },
  ...
  CUW: { name:'Curacao',           flag:'🇨🇼', fifaRank:82, heat:93, pitch:17, altitude:16,  travel:46, crowd:7,  schedule:9,  insight:'Caribbean heat resilience is genuine.' },
  CIV: { name:"Cote d'Ivoire",     flag:'🇨🇮', fifaRank:15, heat:89, pitch:27, altitude:49,  travel:55, crowd:50, schedule:26, insight:'West African heat specialists.' },
  ...
  ESP: { name:'Spain',             flag:'🇪🇸', fifaRank:1,  heat:60, pitch:100,altitude:43,  travel:70, crowd:88, schedule:100,insight:'World champions. Coolest group.' },
  ...
  URU: { name:'Uruguay',           flag:'🇺🇾', fifaRank:16, heat:56, pitch:58, altitude:58,  travel:65, crowd:57, schedule:49, insight:'One of the oldest squads.' },
...
const FIXTURES = [
  ...
  { id:'B5', group:'B', home:'BIH', away:'QAT', venue:'BC Place',              city:'Vancouver',    date:'2026-06-24', roofed:true,  altitude:5    },
  { id:'B6', group:'B', home:'SUI', away:'CAN', venue:'BMO Field',             city:'Toronto',      date:'2026-06-24', roofed:false, altitude:76   },
  { id:'C1', group:'C', home:'HAI', away:'SCO', venue:'Gillette Stadium',      city:'Boston',       date:'2026-06-14', roofed:false, altitude:24   },
  { id:'C2', group:'C', home:'BRA', away:'MAR', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-15', roofed:true,  altitude:186  },
  { id:'C3', group:'C', home:'SCO', away:'MAR', venue:'Gillette Stadium',      city:'Boston',       date:'2026-06-19', roofed:false, altitude:24   },
  { id:'C4', group:'C', home:'BRA', away:'HAI', venue:'Hard Rock Stadium',     city:'Miami',        date:'2026-06-20', roofed:false, altitude:2    },
  { id:'C5', group:'C', home:'SCO', away:'BRA', venue:'Hard Rock Stadium',     city:'Miami',        date:'2026-06-24', roofed:false, altitude:2    },
  { id:'C6', group:'C', home:'MAR', away:'HAI', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-24', roofed:true,  altitude:186  },
  { id:'D1', group:'D', home:'USA', away:'PAR', venue:'SoFi Stadium',          city:'Los Angeles',  date:'2026-06-12', roofed:true,  altitude:89   },
  { id:'D2', group:'D', home:'AUS', away:'TUR', venue:'Lumen Field',           city:'Seattle',      date:'2026-06-13', roofed:false, altitude:4    },
  { id:'D3', group:'D', home:'PAR', away:'TUR', venue:'SoFi Stadium',          city:'Los Angeles',  date:'2026-06-19', roofed:true,  altitude:89   },
  { id:'D4', group:'D', home:'USA', away:'AUS', venue:'Lumen Field',           city:'Seattle',      date:'2026-06-20', roofed:false, altitude:4    },
  { id:'D5', group:'D', home:'TUR', away:'USA', venue:'Lumen Field',           city:'Seattle',      date:'2026-06-25', roofed:false, altitude:4    },
  { id:'D6', group:'D', home:'PAR', away:'AUS', venue:'SoFi Stadium',          city:'Los Angeles',  date:'2026-06-25', roofed:true,  altitude:89   },
  { id:'E1', group:'E', home:'GER', away:'CUW', venue:'MetLife Stadium',       city:'New York',     date:'2026-06-12', roofed:false, altitude:2    },
  { id:'E2', group:'E', home:'CIV', away:'ECU', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-13', roofed:true,  altitude:186  },
  { id:'E3', group:'E', home:'ECU', away:'CUW', venue:'MetLife Stadium',       city:'New York',     date:'2026-06-19', roofed:false, altitude:2    },
  { id:'E4', group:'E', home:'GER', away:'CIV', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-20', roofed:true,  altitude:186  },
  { id:'E5', group:'E', home:'CUW', away:'CIV', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-25', roofed:true,  altitude:186  },
  { id:'E6', group:'E', home:'ECU', away:'GER', venue:'MetLife Stadium',       city:'New York',     date:'2026-06-25', roofed:false, altitude:2    },
  { id:'F1', group:'F', home:'NED', away:'TUN', venue:'Lumen Field',           city:'Seattle',      date:'2026-06-12', roofed:false, altitude:4    },
  { id:'F2', group:'F', home:'JPN', away:'SWE', venue:'Gillette Stadium',      city:'Boston',       date:'2026-06-14', roofed:false, altitude:24   },
  { id:'F3', group:'F', home:'SWE', away:'TUN', venue:'Gillette Stadium',      city:'Boston',       date:'2026-06-19', roofed:false, altitude:24   },
  { id:'F4', group:'F', home:'NED', away:'JPN', venue:'Lumen Field',           city:'Seattle',      date:'2026-06-20', roofed:false, altitude:4    },
  { id:'F5', group:'F', home:'TUN', away:'JPN', venue:'Lumen Field',           city:'Seattle',      date:'2026-06-25', roofed:false, altitude:4    },
  { id:'F6', group:'F', home:'SWE', away:'NED', venue:'Gillette Stadium',      city:'Boston',       date:'2026-06-25', roofed:false, altitude:24   },
  { id:'G1', group:'G', home:'BEL', away:'EGY', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-13', roofed:true,  altitude:186  },
  { id:'G2', group:'G', home:'IRN', away:'NZL', venue:'Gillette Stadium',      city:'Boston',       date:'2026-06-14', roofed:false, altitude:24   },
  { id:'G3', group:'G', home:'EGY', away:'NZL', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-20', roofed:true,  altitude:186  },
  { id:'G4', group:'G', home:'BEL', away:'IRN', venue:'Gillette Stadium',      city:'Boston',       date:'2026-06-21', roofed:false, altitude:24   },
  { id:'G5', group:'G', home:'NZL', away:'BEL', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-26', roofed:true,  altitude:186  },
  { id:'G6', group:'G', home:'EGY', away:'IRN', venue:'Gillette Stadium',      city:'Boston',       date:'2026-06-26', roofed:false, altitude:24   },
  ...
  { id:'H3', group:'H', home:'CPV', away:'URU', venue:'Mercedes-Benz Stadium', city:'Atlanta',      date:'2026-06-21', roofed:true,  altitude:287  },
  { id:'H4', group:'H', home:'ESP', away:'KSA', venue:'Mercedes-Benz Stadium', city:'Atlanta',      date:'2026-06-21', roofed:true,  altitude:287  },
  { id:'H5', group:'H', home:'URU', away:'ESP', venue:'Estadio Akron',         city:'Guadalajara',  date:'2026-06-26', roofed:false, altitude:1566 },
  { id:'H6', group:'H', home:'CPV', away:'KSA', venue:'Hard Rock Stadium',     city:'Miami',        date:'2026-06-26', roofed:false, altitude:2    },
  { id:'I1', group:'I', home:'FRA', away:'SEN', venue:'MetLife Stadium',       city:'New York',     date:'2026-06-14', roofed:false, altitude:2    },
  { id:'I2', group:'I', home:'IRQ', away:'NOR', venue:'Lincoln Financial',     city:'Philadelphia', date:'2026-06-15', roofed:false, altitude:11   },
  { id:'I3', group:'I', home:'SEN', away:'NOR', venue:'MetLife Stadium',       city:'New York',     date:'2026-06-21', roofed:false, altitude:2    },
  { id:'I4', group:'I', home:'FRA', away:'IRQ', venue:'Lincoln Financial',     city:'Philadelphia', date:'2026-06-22', roofed:false, altitude:11   },
  { id:'I5', group:'I', home:'NOR', away:'FRA', venue:'Gillette Stadium',      city:'Boston',       date:'2026-06-27', roofed:false, altitude:24   },
  { id:'I6', group:'I', home:'SEN', away:'IRQ', venue:'Lincoln Financial',     city:'Philadelphia', date:'2026-06-27', roofed:false, altitude:11   },
  { id:'J1', group:'J', home:'ARG', away:'ALG', venue:'Arrowhead Stadium',     city:'Kansas City',  date:'2026-06-16', roofed:false, altitude:290  },
  { id:'J2', group:'J', home:'AUT', away:'JOR', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-17', roofed:true,  altitude:186  },
  { id:'J3', group:'J', home:'ALG', away:'JOR', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-22', roofed:true,  altitude:186  },
  { id:'J4', group:'J', home:'ARG', away:'AUT', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-23', roofed:true,  altitude:186  },
  { id:'J5', group:'J', home:'JOR', away:'ARG', venue:'Arrowhead Stadium',     city:'Kansas City',  date:'2026-06-28', roofed:false, altitude:290  },
  { id:'J6', group:'J', home:'ALG', away:'AUT', venue:'Arrowhead Stadium',     city:'Kansas City',  date:'2026-06-28', roofed:false, altitude:290  },
  { id:'K1', group:'K', home:'POR', away:'COD', venue:'SoFi Stadium',          city:'Los Angeles',  date:'2026-06-16', roofed:true,  altitude:89   },
  { id:'K2', group:'K', home:'UZB', away:'COL', venue:'Rose Bowl',             city:'Los Angeles',  date:'2026-06-17', roofed:false, altitude:258  },
  { id:'K3', group:'K', home:'COD', away:'COL', venue:'Rose Bowl',             city:'Los Angeles',  date:'2026-06-22', roofed:false, altitude:258  },
  { id:'K4', group:'K', home:'POR', away:'UZB', venue:'SoFi Stadium',          city:'Los Angeles',  date:'2026-06-23', roofed:true,  altitude:89   },
  { id:'K5', group:'K', home:'COL', away:'POR', venue:'Rose Bowl',             city:'Los Angeles',  date:'2026-06-28', roofed:false, altitude:258  },
  { id:'K6', group:'K', home:'COD', away:'UZB', venue:'SoFi Stadium',          city:'Los Angeles',  date:'2026-06-28', roofed:true,  altitude:89   },
  { id:'L1', group:'L', home:'ENG', away:'CRO', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-17', roofed:true,  altitude:186  },
  { id:'L2', group:'L', home:'GHA', away:'PAN', venue:'SoFi Stadium',          city:'Los Angeles',  date:'2026-06-18', roofed:true,  altitude:89   },
  { id:'L3', group:'L', home:'ENG', away:'GHA', venue:'Gillette Stadium',      city:'Boston',       date:'2026-06-23', roofed:false, altitude:24   },
  { id:'L4', group:'L', home:'CRO', away:'PAN', venue:'SoFi Stadium',          city:'Los Angeles',  date:'2026-06-24', roofed:true,  altitude:89   },
  { id:'L5', group:'L', home:'ENG', away:'PAN', venue:'MetLife Stadium',       city:'New York',     date:'2026-06-27', roofed:false, altitude:2    },
  { id:'L6', group:'L', home:'CRO', away:'GHA', venue:'AT&T Stadium',          city:'Dallas',       date:'2026-06-27', roofed:true,  altitude:186  },
]
