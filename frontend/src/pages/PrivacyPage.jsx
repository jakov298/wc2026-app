  ...
  return (
    <div style={{ maxWidth:700, margin:'0 auto', padding:'32px 16px', display:'flex', flexDirection:'column', gap:24 }}>
      ...
      <Section title="1. About this site">
        WC 2026 Intelligence (wc2026intelligence.com) is a free football analytics tool providing live power rankings, AI match analysis and condition-adjusted predictions for the 2026 FIFA World Cup.
      </Section>
      ...
      <Section title="5. Third-party services">
        This site uses the following third-party services: Google AdSense (advertising), Anthropic Claude API (AI match analysis), API-Football (live match data), Supabase (database), Vercel (hosting).
      </Section>
      ...
      <Link to="/" style={{ color:'var(--accent)', fontSize:13, fontWeight:600 }}>← Back to home</Link>
    </div>
  )
}
